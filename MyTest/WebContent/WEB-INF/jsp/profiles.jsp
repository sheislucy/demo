...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/css/jquery.pnotify.default.css" />" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="/css/jquery-ui-1.8.18.custom.css" />" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="/css/jquery.pnotify.myTest.css" />" />
<link rel="stylesheet" type="text/css"
...
<body class="front">
	...
	<div id="water-fall-wrapper" class="main-wrapper">
		<%-- <jsp:include page="/WEB-INF/jsp/comp/user.filter.bar.jsp" >
	...
	<script type="text/javascript"
		src="<c:url value="/js/bootstrapx-popoverx.js" />"></script>
	<script type="text/javascript"
		src="<c:url value="/js/jquery.form.js" />"></script>
	<script type="text/javascript"
		src="<c:url value="/js/jquery.pnotify.js" />"></script>
	<script type="text/javascript"
		src="<c:url value="/js/jquery.imagesloaded.js" />"></script>
	<script type="text/javascript"
		src="<c:url value="/js/jquery.masonry.js" />"></script>
	<script type="text/javascript"
		src="<c:url value="/js/jquery.infinitescroll.js" />"></script>
	<script type="text/javascript"
	...
	<script type="text/javascript">
		$(function() {
			...
			function(newElements) {
				...
				$wf.append($newElems).masonry('appended', $newElems, false,
						function() {
