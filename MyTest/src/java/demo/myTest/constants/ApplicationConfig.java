...
public class ApplicationConfig {
	...
	public static String uploadTempRepository = "resources/spot";
	public static String uploadTempRefer = "/resources/spot";
	public static String imageRefer = "/images/spots";
	public static String avatarRefer = "/images/avatars";
	public static String staticRefer = "/MyTest";// FIXME
	...
	public static String[] defaultCategories = new String[] { "时事热点", "本地新闻",
			"美食风暴", "娱乐花边", "购物时尚" };
